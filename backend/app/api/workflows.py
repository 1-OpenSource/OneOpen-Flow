...
def _detail(service: WorkflowService, workflow: Workflow) -> WorkflowDetail:
    ...
    return WorkflowDetail(
        ...
        is_exposed=bool(getattr(workflow, "is_exposed", False)),
        expose_slug=getattr(workflow, "expose_slug", None),
        expose_description=getattr(workflow, "expose_description", None),
        input_schema=getattr(workflow, "input_schema", None) or {},
